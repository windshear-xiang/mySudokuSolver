...
def test_cand_1():
    ...
    cands = [
        [[9], [4], [5, 6], [2, 5], [5, 6, 7], [2, 5, 6, 7], [3], [1], [8]],
        [[1, 3], [7], [2, 6], [1, 3], [6, 8, 9], [6, 8, 9], [5], [2, 9], [4]],
        [[1, 3, 5, 8], [5, 8], [2, 3, 5], [1, 3, 5, 9], [4], [3, 5, 9], [7], [2, 9], [6]],
        [[5, 6, 8], [2], [4, 7], [5, 8, 9], [1], [5, 6, 7, 8, 9], [4, 8, 9], [4, 5], [3]],
        [[3, 5, 8], [1], [4, 7], [2, 3, 5, 8, 9], [5, 7, 8, 9], [2, 3, 5, 7, 8, 9], [4, 8, 9], [6], [2, 5, 9]],
        [[3, 5, 6, 8], [5, 8, 9], [3, 5, 9], [4], [5, 6, 8], [2, 3, 5, 6, 8], [1], [7], [2, 5]],
    ...
    killer_sum_1 = 26
    kc1 = KillerConstraint.create_constraint(pos_list_1, killer_sum_1)

    pos_list_2 = [(1,8), (2,8)]
    killer_sum_2 = 10
    kc2 = KillerConstraint.create_constraint(pos_list_2, killer_sum_2)
